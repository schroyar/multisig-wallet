...
contract MultiSig {
    ...
    function execute(uint _txId) 
        ...
        notExecuted(_txId)
    {
        require(_getApprovalCount(_txId) >= required, "not sufficient approvals to execute the transaction."); 
    ...
    function revoke(uint _txId) 
        ...
        notExecuted(_txId) 
    {
        require(approved[_txId][msg.sender], "transaction not approved by msg.sender");
